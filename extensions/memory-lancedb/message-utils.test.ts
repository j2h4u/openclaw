...
describe("message-utils", () => {
  describe("stripEnvelopeHeader", () => {
    test("strips Telegram envelope", () => {
      const input =
        "[Telegram Maxim ⁽²ʰ⁴ᵘ⁾ (@j2h4u) id:591994976 +5m 2026-02-03 04:53 GMT+5] я люблю ночь";
  ...
  describe("stripMemoryTags", () => {
    ...
    test("strips multiple memory tags", () => {
      const input =
        "<relevant-memories>first</relevant-memories> middle <relevant-memories>second</relevant-memories> end";
...
[message_id: 994]`;
  ...
  describe("parseEnvelopeMetadata", () => {
    test("parses full Telegram envelope", () => {
      const input =
        "[Telegram Maxim ⁽²ʰ⁴ᵘ⁾ (@j2h4u) id:591994976 +5m 2026-02-03 04:53 GMT+5] hello";
